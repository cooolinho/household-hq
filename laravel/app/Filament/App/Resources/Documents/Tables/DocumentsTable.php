...
class DocumentsTable
{
    ...
    private static function previewAction(): Action
    {
        return Action::make('preview')
            ...
            ->modalContent(fn(Document $record) => view('filament.app.resources.documents.modals.preview-content', [
                'document' => $record,
            ]))
            ->modalWidth('7xl')
    ...
    private static function downloadAction(): Action
    {
        return Action::make('download')
            ...
            ->color('success')
            ->url(fn(Document $record) => route('app.documents.download', $record))
            ->openUrlInNewTab();
    }
