...
namespace App\Filament\App\Resources\Financial\Insurances\Widgets;
...
class InsuranceDashboardWidget extends Widget
{
    ...
    protected string $view = 'filament.app.resources.financial.insurances.widgets.insurance-dashboard-widget';
