            ...
            ->components([
                Wizard::make([
                    Step::make('Alte Adresse')
                        ...
                        ->schema([
                            View::make('filament.app.resources.financial.insurances.pages.move-notification-wizard-step-1'),
                        ]),
                    Step::make('Versicherungen & Kanal')
                        ...
                        ->schema([
                            View::make('filament.app.resources.financial.insurances.pages.move-notification-wizard-step-2'),
                        ]),
                    Step::make('Vorschau & Versand')
                        ->description('Texte pruefen, optional bearbeiten und Versand bestaetigen.')
                        ->schema([
                            View::make('filament.app.resources.financial.insurances.pages.move-notification-wizard-step-3'),
                        ]),
                ])
