        ...
        return $schema->components([
            Wizard::make([
                Step::make('Bilder hochladen')
                    ...
                    ->schema([
                        View::make('filament.admin.pages.merge-images-to-pdf-wizard-page-step-1'),
                    ]),
                ...
                Step::make('Reihenfolge')
                    ...
                    ->schema([
                        View::make('filament.admin.pages.merge-images-to-pdf-wizard-page-step-2'),
                    ]),

                Step::make('Dokument')
                    ->description('Beschreibung und Tags für das Dokument festlegen.')
                    ->schema([
                        View::make('filament.admin.pages.merge-images-to-pdf-wizard-page-step-3'),
                    ]),
            ])
