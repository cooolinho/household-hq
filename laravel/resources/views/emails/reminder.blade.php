...
<head>
    ...
    <title>Erinnerung: {{ $reminderTitle }}</title>
</head>
                ...
                <tr>
                    <td style="padding:28px 32px 16px 32px; background:linear-gradient(135deg,#0f172a,#1e293b); color:#fff;">
                        <p style="margin:0 0 8px 0; font-size:12px; letter-spacing:.08em; text-transform:uppercase; opacity:.8;">
                            Erinnerung</p>
                        <h1 style="margin:0; font-size:24px; line-height:1.3;">{{ $reminderTitle }}</h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding:32px;">
                        ...
                        <table style="width:100%; border-collapse:collapse; margin:0 0 24px 0;">
                            <tr>
                                ...
                                <td style="padding:12px 0; border-top:1px solid #e5e7eb; font-size:14px; color:#111827; font-weight:bold;">{{ $scheduleLabel }}</td>
                            </tr>
                        </table>
                        ...
                        @if(!empty($targetUrl))
                            <p style="margin:0 0 28px 0;">
                                <a href="{{ $targetUrl }}"
                                   style="display:inline-block; background:#2563eb; color:#fff; text-decoration:none; font-size:14px; font-weight:bold; padding:12px 18px; border-radius:10px;">Öffnen</a>
                            </p>
                        @endif

                        <p style="margin:0; font-size:13px; color:#6b7280; line-height:1.6;">
                            Du erhältst diese Nachricht, weil eine aktive Erinnerung konfiguriert wurde.
                        </p>
                    </td>
                </tr>
            </table>
